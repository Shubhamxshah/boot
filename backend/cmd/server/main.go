...
import (
	...
	"github.com/infinityos/backend/config"
	"github.com/joho/godotenv"
	db "github.com/infinityos/backend/db/generated"
	dbembed "github.com/infinityos/backend/db/embed"
	"github.com/infinityos/backend/internal/api"
...
func buildOrchestrator(cfg *config.Config) (orchestrator.ContainerOrchestrator, error) {
	...
	default: // "docker"
		dockerOrch, err := orchestrator.NewDockerOrchestrator(cfg.App.GPUEnabled)
		if err != nil {
