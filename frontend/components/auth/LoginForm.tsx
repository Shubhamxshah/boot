  ...
  return (
    <div className="space-y-4">
      <a
        ...
        style={{ background: "#1a2820", border: "1px solid #1f2e28", color: "#e8f0ec" }}
        onMouseOver={(e) => (e.currentTarget.style.background = "#22332a")}
        onMouseOut={(e) => (e.currentTarget.style.background = "#1a2820")}
      >
      ...
      <div className="flex items-center gap-3 text-[#3d5448] text-sm">
